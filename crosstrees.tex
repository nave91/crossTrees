...
\title{Explain Multi-Objective Optimizers (in Linear Time)}
...
\institute{Comptuer Science, West Virginia University, NcState UNiversity, USA\\
nalekkalapudi@mix.wvu.edu, tim.menzies@gmail.com}
...
\begin{abstract}
CROSSTREES is a near linear-time algorithm for generating
succinct explainations of a Pareto frontier. 
A human inspecting CROSSTREES' output can quickly infer changes
that can improve their situation. This paper assess the value of those
changes by applying those changes as constraints on various models
of different software engineering processes 
that applied CROSSTREE's models to (a) the POM3 model of agile selection
of tasks; (b) four COCOMO-suite predictors for effort, months, defects and risk.
These recommendations were found to be competitive with the
recommendations of standard multi-objective
optimizers (NSGA-II and SPEA2). Further, CROSSTREES' recommendations
were generated orders of magnitude faster than those found by
NSGA-II and SPEA2. Hence, at the very least, we recommend
CROSSTREES as an explanation post-processor to other MOEAs.
That said, CROSSTREES could also serve as an MOEA in its own right.
\keywords{Optimization, multi-objective,
explanation, software engineering, We would like to encourage you to list your keywords within
the abstract section}
\end{abstract}


\section{Introduction}
A standard technique in SBSE is the exploration of thousands to millions
of randomly
...
to \url{SDC.bookorder@springer.com}, giving full
